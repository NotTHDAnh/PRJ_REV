...
public class SearchLastnameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");// ho tro dinh dang trinh bay duoi dang 
        ...
        try{
            if(searchValue.trim().length() > 0){
                ...
                url = RESULT_PAGE;
                // controller gui dia chi cua attribute la search_result den view
                
    //                if(result != null){// serach has atleast 1 item
    //                    log("Search Result:\n");
    //                    log("STT \t Username \t Password \t Full Name \t Role\n");
    //                    int count = 0;
    ...
    //                } 
                // neu attribute chua ton tai -> new attribute
                // neu attribute ton tai -> cap nhat gia tri
            }// search when user typed a valid value
