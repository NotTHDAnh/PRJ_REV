...
//2.1 Controller se khoi tao DAO object ( new operator)
...
//4 Tao DAO class neu can ( neu co thi lay ra dung, neu khong thi tao moi )
        } finally {
            //send to view
            RequestDispatcher rd = request.getRequestDispatcher(url);
            rd.forward(request, response);
//response.sendRedirect(url); //di va khong du lai ( trai nguoc voi 2 dong kia )
            out.close();
        }
    }
