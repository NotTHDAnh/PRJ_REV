    ...
    throws ServletException, IOException {
        ...
        try {
            if (searchValue.trim().length() > 0){
                ...
                // 2.1 Controller initialize DAO Object
                ...
                // Controller forward result address to View
                request.setAttribute("SEARCH_RESULT", result); // result in DTO, then put it in request attribute
                url = RESULT_PAGE;

                
//                if (result != null) { // have atleast 1 record
