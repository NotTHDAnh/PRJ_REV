...
//    Do not change this code
    ...
    public static Connection getConnection() throws ClassNotFoundException, SQLException {
        ...
        conn = DriverManager.getConnection(url, DB_USER_NAME, DB_PASSWORD);//open connection. Ham nay khi chay co loi xay ra -> SQLException.dc
        // 3 buoc tren la buoc 14 tren so do
        return conn;
    }
}
