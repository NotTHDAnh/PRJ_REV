...
public class UpdatePassRoleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String roleString = request.getParameter("chckAdmin");
...
//            RegistrationDAO dao = new RegistrationDAO();
            ...
            //3 Controller processed results
        }catch(SQLException ex){
            log("UpdatePassRoleServlet _ SQL" + ex.getMessage());
        }catch(ClassNotFoundException ex){
            log("UpdatePassRoleServlet _ Class Not Found" + ex.getMessage());
        }finally{
